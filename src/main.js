...
function getQuestState(registry) {
    if (!registry.get('questState')) {
        registry.set('questState', {
            ...
            objective: 'Ambil Pisau & Roti Bekal di rumah, lalu pergi ke Timur.',
            questNumber: 0,
            completedQuests: []
        });
    }
...
class HomeScene extends BaseScene {
    ...
    create(data = {}) {
        ...
        let startX = 80;
        if (data && data.from === 'ForestTrailScene') {
            startX = 720;
        }
            ...
            onExitRight: () => {
                ...
                if (!hasDagger || !hasBread) {
                    this.checkMapGate({
                        ...
                        reqQuestNum: 1,
                        lockMessage: 'Ambil Pisau Belati & Roti Bekal di meja sebelum berangkat ke Hutan!',
                        direction: 'right'
                    });
                } else {
...
const config = {
    ...
    scene: [BootScene, TitleScene, HomeScene, ForestTrailScene, WitchYardScene, WitchCottageScene, GrandmaGardenScene, BeeGardenScene, WoodshopScene, FirewoodForestScene, BakeryMillScene, VillageResidentialScene, EastForestScene]
};
